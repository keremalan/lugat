                                ...
                                onPressed: () {
                                  ...
                                  if (formState.validate() == true) {
                                    ...
                                    FirebaseFirestore.instance.collection('terms').add({
                                      'termTitle': termTitle, 'termImage': termImage, 'termCategory': termCategory,'termImage': termImage, 'termMean': termMeans, 'termExample': termExample, 'termDescription': termDescription, 'termAuthor': '${FirebaseAuth.instance.currentUser!.displayName!}', 'isSaved': false, 'uid': uid, 'termContributor': termContributor,
                                    });
